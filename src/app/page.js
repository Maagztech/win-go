...
export default function Home() {
  ...
  return (
    <>
      <Head>
        <title>Login Bitcoin Cashout</title>
        <meta name="description" content="Join us to cash out your Bitcoin easily and securely. Sign in with Google to get started." />
      </Head>
